                ...
                <button
                  ...
                  className={`${
                    billingInterval === 'month'
                      ...
                      : 'ml-0.5 relative w-1/2 border border-transparent 400'
                  } rounded-md m-1 py-2 text-sm font-medium whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50 focus:z-10 sm:w-auto sm:px-8`}
                >
                  Monthly billing
                </button>
              )}
              ...
              return (
                ...
                >
                  <div className="p-6">
                    ...
                    <p className="mt-4 300">{product.description}</p>
                    <p className="mt-8">
                      <span className="text-5xl font-extrabold white">
                        {priceString}
                      </span>
                      <span className="text-base font-medium 100">
                        /{billingInterval}
                      </span>
                    </p>
                    <Button
